 export default class PixNoValue {
    constructor(pixKey, description, merchantName, merchantCity, txid) {
      this.pixKey = pixKey;
  ...
  // const test = new PixNoValue('+5521972420018', 'testeteste', 'Fabio de Pinho Aguiar', 'Rio de Janeiro', 'cobrancateste');
  // const testPayload = test.getPayload2();
